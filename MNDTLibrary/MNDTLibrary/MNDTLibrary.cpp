	...
	, UINT32* numCss)
{
	...
	std::map<UINT32, Region> R = segment.SelectiveSearch(src, pur
		, width, height
		, sigma, threshold, minSize);

	Image purImage(pur, width, height, MNDT::ImageType::BGR_24BIT);

	segment.Visualization(purImage, R);
}

extern "C" MNDTLIBRARY_API void mndtFaceSearch(C_UCHAR* src, UCHAR* pur
	, C_UINT32 width, C_UINT32 height
	, C_FLOAT sigma, C_FLOAT threshold, C_UINT32 minSize
	, UINT32* numCss)
{
	...
	MNDT::Detection::PredictFeature(src, width, height, R);
...
extern "C" MNDTLIBRARY_API void mndtLBPHistogram(C_UCHAR* src
	, C_UINT32 width, C_UINT32 height
...
extern "C" MNDTLIBRARY_API void mndtContourFrame8bit(C_UCHAR* src, UCHAR* pur
	, C_UINT32 width, C_UINT32 height)
{
	MNDT::ContourFrame8bit(src, pur
		, width, height);
}

extern "C" MNDTLIBRARY_API void mndtMarkLine(C_UCHAR* src, UCHAR* pur
	, C_UINT32 width, C_UINT32 height)
{
	memcpy(pur, src, width * height * 3);
...
extern "C" MNDTLIBRARY_API void mndtThresholdingOTSU(C_UCHAR* src, UCHAR* pur
	, C_UINT32 width, C_UINT32 height)
{
	MNDT::ThresholdingOTSU(src, pur, width, height);
}

extern "C" MNDTLIBRARY_API void mndtExpansion8bit(C_UCHAR* src, UCHAR* pur
	, C_UINT32 width, C_UINT32 height
	, C_UINT32 block)
{
	MNDT::Expansion8bit(src, pur, width, height, block);
}

extern "C" MNDTLIBRARY_API void mndtErosion8bit(C_UCHAR* src, UCHAR* pur
	, C_UINT32 width, C_UINT32 height
	, C_UINT32 block)
{
	MNDT::Erosion8bit(src, pur, width, height, block);
}
